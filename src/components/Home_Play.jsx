...
function Home_play() {
  const games = [
    ...
    },
    {
      ...
      startTime: "8:00 AM",
      endTime: "9:00 AM",
      place: "Ace Tennis Club, Jubilee Hills",
    },
  ];
      ...
      <div className="grid grid-cols-4 gap-6">
        {games.map((g) => (
          ...
          >
            ...
            <div className="text-sm text-gray-400 mt-1">{g.place}</div>
          </div>
        ))}
      </div>
    </Section>
